...
#pragma omp parallel
  {
#pragma omp single
    printf("\nLiczba wątków ustawiona w zmiennej środowiskowej %d\n",
           omp_get_num_threads());
  }
...
#pragma omp parallel
  {
#pragma omp single
    printf("\nLiczba wątków ustawiona za pomocą funkcji bibliotecznej %d\n",
           omp_get_num_threads());
  }
...
#pragma omp parallel num_threads(7)
  {
#pragma omp single
    printf("\nLiczba wątków ustawiona za pomocą dyrektywy %d\n",
           omp_get_num_threads());
  }
...
#pragma omp single
  ...
  printf("\nprzed wejsciem do obszaru rownoleglego -  nr_threads %d, thread ID "
         "%d\n",
...
#pragma omp parallel default(none)                                             \
    shared(a_shared, e_atomic) private(b_private) firstprivate(c_firstprivate)
  {
    int i;
    int d_local_private;
