...
#pragma omp task final(poziom > max_poziom) default(none)                      \
                           firstprivate(A, p, r, q1, poziom)
...
#pragma omp task final(poziom > poziom_max) default(none)                      \
                           firstprivate(A, p, r, q1, poziom)
    {
      if (omp_in_final())
...
void merge_sort_openmp_4(double *A, int p, int r) {
